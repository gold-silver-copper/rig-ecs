...
- Target-dependent public concurrency bounds or missing `wasm32-unknown-unknown` compatibility; public contracts use ordinary `Send` and `Sync` consistently on every target
