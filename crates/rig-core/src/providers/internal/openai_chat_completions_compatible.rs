...
pub(crate) trait CompatibleStreamProfile: Send {
    type Usage: Clone + Default + GetTokenUsage + Send + 'static;
    type Detail: Send + 'static;
    type FinalResponse: Clone + Unpin + GetTokenUsage + Send + 'static;
